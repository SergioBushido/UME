...
import { es } from 'date-fns/locale' // Assuming locale is needed, if installed. Or default.
        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-7 gap-1">
                {days.map((day, i) => {
                    ...
                    let cursorClass = mode === 'admin' ? "cursor-pointer hover:ring-2 hover:ring-primary/50" : "cursor-default"
                    ...
                    return (
                        <div
                            ...
                            className={cn(
                                "min-h-[80px] p-2 border rounded-md flex flex-col justify-between text-sm transition-all relative",
                                bgClass,
                                borderClass,
                                cursorClass,
                                    ...
                                    {mode === 'admin' ? (
                                        <>
                                            ...
                                            <div className="w-full bg-gray-200 rounded-full h-1.5 dark:bg-gray-700 mt-1">
                                                <div
                                                    className={cn("h-1.5 rounded-full", remaining <= 0 ? "bg-red-500" : "bg-green-500")}
                                                    style={{ width: `${Math.min(100, (approved / max) * 100)}%` }}
                                                />
                                            </div>
                                        </>
                                    ) : (
